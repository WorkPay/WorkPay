...
public class GestionAsistencia {
    ...
    private static final String INSERT = "INSERT INTO asistencia (Fecha, Trabajador, Dia, Sueldo_historico) VALUES (?, ?, ?, ?)";
    ...
    public void insertAsistenciaHisto(asistencia asis) {
        ...
        try {
            ...
            st.setString(1, asis.getFecha().toString());
            st.setString(2, asis.getTrabajador());
            st.setString(3, Double.toString(asis.getDia()));
            st.setString(4, Integer.toString(asis.getSueldo_historico()));
